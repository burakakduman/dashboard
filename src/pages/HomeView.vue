        ...
        <div class="row q-col-gutter-md top">
            ...
            <div class="col-12">
                <q-card class="q-mx-md q-pa-md doctors" bordered>
                    ...
                    <div class="">
                        <q-carousel v-model="slide" vertical transition-prev="jump-down" transition-next="jump-up" swipeable
                            animated control-color="green-7" navigation padding arrows height="160px"
                            class="text-black shadow-1 rounded-borders">
                            <template v-slot:navigation-icon="{ active, btnProps, onClick }">
                                <q-btn v-if="active" size="lg" icon="home" color="green" flat round dense
                                    @click="onClick" />
                                <q-btn v-else size="sm" :icon="btnProps.icon" color="black" flat round dense
                                    @click="onClick" />
                            </template>
